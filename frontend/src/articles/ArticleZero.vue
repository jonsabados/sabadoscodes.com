<template>
  <div class="article">
    ...
    <h2>Code!!!!</h2>
    <p>
      Now for the fun stuff, time to write some code! Or at least generate a vue.js app and spit out a bunch of
...
aws s3 cp "s3://$UI_BUCKET/index.html" "s3://$UI_BUCKET/index.html" --metadata-directive REPLACE  --cache-control max-age=60 --acl public-read
  ...
  custom_error_response {
    ...
    <p>
      ...
      This tag also contains a some initial work on the vue app which is not discussed in this article.
    </p>
  </div>
</template>
